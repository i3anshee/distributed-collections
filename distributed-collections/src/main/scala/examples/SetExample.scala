...
object SetExample {
  def main(args: Array[String]) {
    ...
    messages += "(0 to 99) + 12345 contains 12345 =" + ((distributedSet + 12345).contains(12345).toString())
    messages += "(0 to 99) + 12345 contains 12346 =" + ((distributedSet + 12345).contains(12346).toString())
    messages += "(0 to 99) union (0 to 2000) =" + ((distributedSet + 12345).contains(12346).toString())
